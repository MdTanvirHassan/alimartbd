...
class HomeController extends Controller
{
    ...
    {
        $page =  Page::where('type', 'delivery_policy_page')->first();
        return view("frontend.policies.deliverypolicy", compact('page'));
    }
    
    public function cancellationpolicy()
    {
        $page =  Page::where('type', 'cancellation_policy_page')->first();
        return view("frontend.policies.cancellationpolicy", compact('page'));
    }
