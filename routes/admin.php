...
use App\Http\Controllers\Payment\Shurjopay2Controller;
...
// Pathao Courier
Route::controller(PathaoCourierController::class)->group(function () {
    Route::get('/pathao_courier', 'index')->name('pathao.index');
    Route::get('/pathao_courier/store_list', 'store_list')->name('pathao.store_list');
    Route::get('/pathao_courier/store', 'Store')->name('pathao.Store');
    Route::get('/pathao_courier/order/{id}', 'order')->name('pathao.order');
    Route::get('/pathao_courier/get_city', 'get_city')->name('pathao.get_city');
    Route::get('/pathao_courier/get_zone', 'get_zone')->name('pathao.zone');
    Route::post('/pathao_courier/getZone', 'getZone')->name('pathao.zone2');
    Route::post('/pathao_courier/getArea', 'getArea')->name('pathao.area2');
    Route::post('/pathao_courier/getInfo', 'getInfo')->name('pathao.getinfo');
    Route::get('/pathao_courier/get_area', 'get_area')->name('pathao.get_area');
    Route::post('/pathao_courier/issue-token', 'issueToken')->name('pathao.issueToken');
    Route::post('/pathao_courier/newOrder', 'newOrder')->name('pathao.newOrder');
    Route::post('/pathao_courier/newBulkOrder', 'newBulkOrder')->name('pathao.newBulkOrder');
    Route::post('/pathao_courier/newStore', 'newStore')->name('pathao.newStore');
    Route::post('/pathao_courier/saveStore', 'saveStore')->name('pathao.saveStore');
    Route::post('/pathao_courier/saveOrder', 'saveOrder')->name('pathao.saveOrder');

    Route::post('/pathao_courier/bulk_order', 'bulk_order')->name('pathao.bulk_order');
});

//Steadfast Courier
Route::controller(SteadfastCourierController::class)->group(function () {

    Route::get('/steadfast_courier/{id}', 'index')->name('steadfast.order');
    Route::post('/steadfast_courier/bulk_order', 'bulk_order')->name('steadfast.bulk_order');
});
