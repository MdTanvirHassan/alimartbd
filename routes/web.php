...
use App\Http\Controllers\Payment\ShurjopaymentController;
...
Route::get('success-url','App\Http\Controllers\Payment\ShurjopaymentController@verifyPayment');
...
Route::controller(HomeController::class)->group(function () {
    ...
    Route::get('/cancellation-policy', 'cancellationpolicy')->name('cancellationpolicy');
