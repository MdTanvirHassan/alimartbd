                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form class="form-horizontal" action="{{ route('payment_method.update') }}" method="POST">
                            ...
                            @csrf
                            <div class="form-group row">
                                <input type="hidden" name="types[]" value="MERCHANT_USERNAME">
                                <div class="col-md-4">
                                    <label class="col-from-label">{{ translate('Merchant Username') }}</label>
                                </div>
                                <div class="col-md-8">
                                    <input type="text" class="form-control" name="MERCHANT_USERNAME"
                                        value="{{ env('MERCHANT_USERNAME') }}"
                                        placeholder="{{ translate('Merchant Username') }}" required>
                                </div>
                            </div>
                            <div class="form-group row">
                                <input type="hidden" name="types[]" value="MERCHANT_PASSWORD">
                                <div class="col-md-4">
                                    <label class="col-from-label">{{ translate('Merchant Password') }}</label>
                                </div>
                                <div class="col-md-8">
                                    <input type="text" class="form-control" name="MERCHANT_PASSWORD"
                                        value="{{ env('MERCHANT_PASSWORD') }}"
                                        placeholder="{{ translate('Merchant Password') }}" required>
                                </div>
                            </div>
                            <div class="form-group row">
                                <input type="hidden" name="types[]" value="MERCHANT_PREFIX">
                                <div class="col-md-4">
                                    <label class="col-from-label">{{ translate('Merchant Prefix') }}</label>
                                </div>
                                <div class="col-md-8">
                                    <input type="text" class="form-control" name="MERCHANT_PREFIX"
                                        value="{{ env('MERCHANT_PREFIX') }}"
                                        placeholder="{{ translate('Merchant Prefix') }}" required>
                                </div>
                            </div>
                            <div class="form-group row">
                                <input type="hidden" name="types[]" value="MERCHANT_RETURN_URL">
                                <div class="col-md-4">
                                    <label class="col-from-label">{{ translate('Merchant Return URL') }}</label>
                                </div>
                                <div class="col-md-8">
                                    <input type="text" class="form-control" name="MERCHANT_RETURN_URL"
                                        value="{{ env('MERCHANT_RETURN_URL') }}"
                                        placeholder="{{ translate('Merchant Return URL') }}" required>
                                </div>
                            </div>
                            <div class="form-group row">
                                <input type="hidden" name="types[]" value="MERCHANT_CANCEL_URL">
                                <div class="col-md-4">
                                    <label class="col-from-label">{{ translate('Merchant Cancel URL') }}</label>
                                </div>
                                <div class="col-md-8">
                                    <input type="text" class="form-control" name="MERCHANT_CANCEL_URL"
                                        value="{{ env('MERCHANT_CANCEL_URL') }}"
                                        placeholder="{{ translate('Merchant Cancel URL') }}" required>
                                </div>
                            </div>
                            <div class="form-group row">
                                <input type="hidden" name="types[]" value="ENGINE_URL">
                                <div class="col-md-4">
                                    <label class="col-from-label">{{ translate('ENGINE URL') }}</label>
                                </div>
                                <div class="col-md-8">
                                    <input type="text" class="form-control" name="ENGINE_URL"
                                        value="{{ env('ENGINE_URL') }}"
                                        placeholder="{{ translate('ENGINE URL') }}" required>
                                </div>
                            </div>
                            <div class="form-group mb-0 text-right">
                                <button type="submit" class="btn btn-sm btn-primary">{{ translate('Save') }}</button>
