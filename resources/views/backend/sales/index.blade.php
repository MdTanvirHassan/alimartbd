                ...
                @can('delete_order')
                    <div class="dropdown mb-2 mb-md-0">
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            ...
                            <a class="dropdown-item confirm-alert" href="javascript:void(0)"  data-target="#bulk-courier-modal">
                                {{ translate('Courier selection') }}</a>
                        </div>
                    </div>
                @endcan
                                    ...
                                    <?php
                                        ...
                                        ?>
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu" aria-labelledby="courierDropdown">
                                                    @if ($pathao_activation_check=='1')
                                                        <a class="dropdown-item" href="{{ route('pathao.order', $order->id) }}" target="_blank">{{ translate('Pathao Courier') }}</a>
                                                    @endif
                                                    @if ($steadfast_activation_check=='1')
                                                        <a class="dropdown-item" href="{{ route('steadfast.order', $order->id) }}" target="_blank">{{ translate('Steadfast Courier') }}</a>
                                                    @endif
                                                </div>
                                            </div>
                                    @if (addon_is_activated('pos_system') && $order->order_from == 'pos')
        ...
        function bulk_courier() {
            ...
            if (selectedCourier === 'pathao') {
                ...
                $.ajax({
                    ...
                    url: "{{ route('steadfast.bulk_order') }}",
                    type: 'POST',
                    data: data,
                    cache: false,
                    contentType: false,
